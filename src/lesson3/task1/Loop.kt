...
fun main(args: Array<String>){
    ...
    print("5 < 5.0 is "); println(5 < 5.0)
    println(squareBetweenExists(80, 80))
...
fun squareBetweenExists(m: Int, n: Int): Boolean {
    for (i in m..n)
        if (!(sqrt(i.toDouble()).toInt() < sqrt(i.toDouble()))) return true //Понимаю, >= проще чем !<,но так-нагляднее
    return false
}
